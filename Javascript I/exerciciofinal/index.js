...
function exibirVaga() {
  ...
  while (!vaga) {
    alert("Vaga Inexistente, insira uma vaga válida\n Para retonar ao menu digite voltar")
    indice = prompt("Informe o índice da vaga que deseja exibir:")
    if (indice === 'voltar') {
      return null
  }
}
...
function inscreverCandidato() {
  ...
  while (!vaga) {
    alert("Vaga Inexistente, insira uma vaga válida\n Para retonar ao menu digite voltar")
    indice = prompt("Informe o índice da vaga para a qual o(a) candidato(a) deseja se inscrever:")
    if (indice === 'voltar') {
      return null
    }
    vaga = vagas[indice]
...
function excluirVaga() {
  ...
  while (!vaga) {
    alert("Vaga Inexistente, insira uma vaga válida\n Para retonar ao menu digite voltar")
    indice = prompt("Informe o índice da vaga que deseja excluir:")
    if (indice === 'voltar') {
      return null
    }
  }
